...
for i=4:arr_num
    if bb4_a(length(member_A_b_b))== min(bb4_a(length(member_A_b_b)),min(bb4_b(length(member_B_b_b)),bb4_c(length(member_C_b_b))))
        ...
        number=sum(bb3_a(1:len_A_mem_b_b-1)>=bb1_a(len_A_mem_b_b));
          ...
          Pointer=Pointer+1;
    elseif bb4_b(length(member_B_b_b))== min(bb4_a(length(member_A_b_b)),min(bb4_b(length(member_B_b_b)),bb4_c(length(member_C_b_b))))
         ...
         number=sum(bb3_c(1:len_C_mem_b_b-1)>=bb1_c(len_C_mem_b_b));
          if number ==0
           ...
           bottleBb(rem(Pointer+1,10)+1)=bb2_c(len_C_mem_b_b)-bb1_c(len_C_mem_b_b);
          Pointer=Pointer+1;      
    end
    if (MODEL==1)
...
len_B_mem_b_b = length(member_B_b_b);
len_C_mem_b_b = length(member_C_b_b);
bb1=[bb1_a(1:len_A_mem_b_b) bb1_b(1:len_B_mem_b_b) bb1_c(1:len_C_mem_b_b)];
bb2=[bb2_a(1:len_A_mem_b_b) bb2_b(1:len_B_mem_b_b) bb2_c(1:len_C_mem_b_b)];
bb3=[bb3_a(1:len_A_mem_b_b) bb3_b(1:len_B_mem_b_b) bb3_c(1:len_C_mem_b_b)];
bb4=[bb4_a(1:len_A_mem_b_b) bb4_b(1:len_B_mem_b_b) bb4_c(1:len_C_mem_b_b)];
bb6=[bb6_a(1:len_A_mem_b_b) bb6_b(1:len_B_mem_b_b) bb6_c(1:len_C_mem_b_b)];
b_tmp=[bb1;bb2;bb3;bb4;bb6];
b_tmp_=sortrows(b_tmp',5);
b_tmp=b_tmp_';
bb1=b_tmp(1,:);
bb2=b_tmp(2,:);
bb3=b_tmp(3,:);
...
%% D 区复查
if sum(bb5_a)+sum(bb5_b)+sum(bb5_c)==0
    bb5_a(1)=1;
end
