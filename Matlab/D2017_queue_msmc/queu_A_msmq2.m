...
%arr_time=poissrnd(70,[1,arr_num]);%观点分布泊松分布偏分布，
...
for i=3:arr_num
    if a4_a(length(member_A))< a4_b(length(member_B))
            ...
            number=sum(a3_a(1:len_A_mem-1)>=a1_a(len_A_mem));
              if number ==0
                ...
                a4_a(len_A_mem)=1;
                 ...
                 a2_a(len_A_mem)=a3_a(len_A_mem-1)+Delay(i);                     %文化因素:加延迟
    %             a2_a(len_A_mem)=a3_a(len_A_mem-1);%无延迟
                a3_a(len_A_mem)=a2_a(len_A_mem)+state_a(len_A_mem);
         ...
         number=sum(a3_b(1:len_B_mem-1)>=a1_b(len_B_mem));
          if number ==0
            ...
            a2_b(len_B_mem)=a3_b(len_B_mem-1)+Delay(i); %文化因素:加延迟
%             a2_b(len_B_mem)=a3_b(len_B_mem-1);        %无延迟
            a3_b(len_B_mem)=a2_b(len_B_mem)+state_b(len_B_mem);
...
len_A_mem = length(member_A);
len_B_mem = length(member_B);
a1=[a1_a(1:len_A_mem) a1_b(1:len_B_mem) ];
a2=[a2_a(1:len_A_mem) a2_b(1:len_B_mem) ];
a3=[a3_a(1:len_A_mem) a3_b(1:len_B_mem) ];
a4=[a4_a(1:len_A_mem) a4_b(1:len_B_mem) ];
a_tmp=[a1;a2;a3;a4];
